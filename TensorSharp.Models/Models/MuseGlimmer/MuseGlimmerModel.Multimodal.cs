...
//
// Muse-Glimmer's multimodal contract.
...
{
    public partial class MuseGlimmerModel : IVisionCapableModel, IMultimodalPromptExpander
    {
        ...
        List<int> IMultimodalPromptExpander.ExpandMultimodalPrompt(
            ...
            => injector.ProcessMuseGlimmerHistory(this, history, inputTokens);
    }
}
