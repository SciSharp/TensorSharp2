...
window.SEARCH_INDEX_ZH = [
  ...
  { t: "MiniMax-H3 对比 stable-diffusion.cpp", p: "视频生成", u: "models-video.html#minimax-h3", s: "M5 Pro、ggml_metal、22 帧、8 步、同一随机种子实测：256×256 快 2.4×（49.3 s → 20.9 s），640×384 快 1.7×（108.5 s → 63.1 s）。", k: "minimax h3 基准 benchmark stable-diffusion.cpp sd.cpp m5 pro metal 加速 2.4x 1.7x 256 640 384 秒 更快" },
