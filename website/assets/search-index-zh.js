...
window.SEARCH_INDEX_ZH = [
  ...
  { t: "Wan 2.1 / 2.2 —— 下载并运行", p: "视频生成", u: "models-video.html#wan", s: "文生视频与图生视频的 hf download 与 CLI / Server 命令，含步数蒸馏的 Turbo 检查点。", k: "wan 下载 运行 cli server video-frames fps t2v i2v turbo 蒸馏 umt5 vae" },
